...
public class Biblioteca {
        ...
        void registro() {
                ...
                // registrar Libros
                libros[0] = new Libro("El retrato de la muerte", "Ray Bradbury", "0001", 1955, true, "434JKLJFAISF7",
                                "Planeta",
                                1);
                ...
                libros[6] = new Libro("Principio del derecho", "Ray Bradbury", "0007", 1955, true, "ASDU6ASFHKAJFH",
                                "Planeta",
                                3);
                libros[7] = new Libro("Que pasa con mi cuerpo?", "Jordi Rosado", "0008", 1955, true, "AS8D7AFHSJFASF",
                                "Planeta", 3);
                libros[8] = new Libro("las cronicas de Narnia", "C.S. Lewis", "0009", 1955, true, "GOJOUE8978A6GS",
                                "Planeta",
                                3);
                libros[9] = new Libro("Piratas del Caribe", "Ray Bradbury", "0010", 1955, true, "POIFAOSPFAI977",
                                "Planeta", 3);
                libros[10] = new Libro("El Principio", "Ray Bradbury", "0011", 1955, true, "IKAFOIA8S66AFG", "Planeta",
                                3);

                // registrar Revistas
                revistas[0] = new Revista("10 habitos exitosos", "Sandra Bullock", "0022", 1955, true,
                                "KLAHSFIASFU78903",
                                "Planeta", 1);
                revistas[1] = new Revista("Muy interesante", "Sandra Bullock", "0012", 1955, true, "ASOFIAS7FA65",
                                "Planeta",
                                3);
                ...
                revistas[4] = new Revista("Tesla el gigante", "Elon Musk", "0015", 1955, true, "76A54768UHJKAFDS",
                                "Planeta",
                                3);
                revistas[5] = new Revista("History channel", "Ray Bradbury", "0016", 1955, true, "A795S87ASFGKJA",
                                "Planeta",
                                3);
                revistas[6] = new Revista("Animal Planet", "Ray Bradbury", "0017", 1955, true, "ASOIFYAS76FA1",
                                "Planeta", 3);
                revistas[7] = new Revista("Para adultos", "Ray Bradbury", "0018", 1955, true, "OAIUSI9FI07AS08F",
                                "Planeta", 3);
                revistas[8] = new Revista("Emprendedores", "Ray Bradbury", "0019", 1955, true, "APS9F87A9SFDAHSJD",
                                "Planeta",
                                3);
                revistas[9] = new Revista("Ecomista", "Ray Bradbury", "0020", 1955, true, "87A5S68DASGHDJAAS",
                                "Planeta", 3);
                revistas[10] = new Revista("Cosmopolitan", "Ray Bradbury", "0021", 1955, true, "89567A467DSGYAGS",
                                "Planeta",
                                3);
